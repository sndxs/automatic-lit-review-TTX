...
\title{Test-Taker Experiences of Standardized Testing:\\ A Scoping Literature Review\thanks{This is an automatically machine-generated draft, prepared by the \emph{TTX Automatic Literature Reviewer} pipeline. It should be treated as an experiment in automated literature synthesis, not an official literature review.}}
...
\subsection{Automatically Found Candidates Pending Full Review}
\label{sec:auto_pending}

The counts above describe this review's last full manual screening pass. Papers listed below were found by the automated pipeline afterward and have not yet been read in full or formally screened for inclusion by a human reviewer; where a paper's abstract suggested a clear thematic fit, a brief provisional mention citing it was added to the relevant subsection below, marked as such. Nothing in this list should be treated as a verified finding until manually reviewed and, if appropriate, folded into the counts and synthesis above.

\begin{itemize}[leftmargin=*]
% AUTO-PENDING-LIST-START
\item \citet{campos2016efectos} -- \emph{EFECTOS INDESEADOS DE LA MEDICIÓN DE LA CALIDAD EDUCATIVA EN CHILE. LA RESPUESTA DE LA SOCIEDAD CIVIL} (openalex [es]). Found 2026-09-08. Cited provisionally in the ``Response Processes and Test-Taking Strategies (Spanish-Language Literature)'' subsection.
\item \citet{chavesmanzano2020cavilaciones} -- \emph{Cavilaciones sobre la evaluación y la calidad educativa en Colombia} (openalex [es]). Found 2026-09-08. Cited provisionally in the ``Response Processes and Test-Taking Strategies (Spanish-Language Literature)'' subsection.
\item \citet{parcerisa2021movimientos} -- \emph{Movimientos sociales y resistencia al accountability en Chile: estrategias discursivas, identidad y acciones de la campaña Alto al SIMCE} (openalex [es]). Found 2026-09-08. Cited provisionally in the ``Response Processes and Test-Taking Strategies (Spanish-Language Literature)'' subsection.
\item \citet{braun2004highstakes} -- \emph{Reconsidering the Impact of High-stakes Testing} (openalex [en]). Found 2026-09-07. Cited provisionally in the ``Systemic and Policy-Level Consequences'' subsection.
\item \citet{carrasco2019identidad} -- \emph{Identidad docente y políticas de accountability: el caso de Chile} (openalex [es]). Found 2026-09-07. Cited provisionally in the ``Teacher and Institutional Perspectives'' subsection.
% AUTO-PENDING-LIST-END
\end{itemize}
...
Reanalyzing state-level NAEP mathematics results from 1992 to 2000, \citet{braun2004highstakes} challenges earlier claims that high-stakes testing accountability policies fail to improve student achievement, finding that comparisons of state gains over time generally favor high-stakes testing states even as cohort-based analyses yield more mixed results.
...
Drawing on interviews and focus groups with teachers in vulnerable Chilean municipal schools, \citet{carrasco2019identidad} shows how accountability policies built around high-stakes standardized testing standardize teachers' work and technify their professional identity, even as many respond by reaffirming vocation and commitment amid perceived social discredit of the profession.
...
In a five-year qualitative study of three Santiago schools, \citet{campos2016efectos} document the unintended effects of standardized accountability testing in Chile and the civil society campaign that emerged to contest it.

Drawing on a qualitative literature review, \citet{chavesmanzano2020cavilaciones} trace how evaluation and standardized testing have become increasingly central to definitions of educational quality in Colombia.

Using a social movements framework and qualitative case study methods, \citet{parcerisa2021movimientos} examine the discursive strategies, collective identity, and repertoires of action of the "Alto al SIMCE" campaign against test-based accountability in Chile.
...
Amsberry, P. V. S. (2018). Testing, testing, 1 2 3: Exploring the mitigating effects of sound on test performance. OSF Preprints. \url{https://osf.io/dtk9f}
...
Araneda, S., Sireci, S. G., Crespo Cruz, E., \& Mena Serrano, F. (2025). A conceptual framework for test-taker experience in educational testing (Version 0) [Unpublished manuscript]. Caveon; University of Massachusetts Amherst.

\bibitem[Balash et al.(2021)]{balash2021examiners}
Balash, D. G., Kim, D., Shaibekova, D., Fainchtein, R. A., Sherr, M., \& Aviv, A. J. (2021). Examining the examiners: Students' privacy and security perceptions of online proctoring services. arXiv. \url{https://doi.org/10.48550/arXiv.2106.05917}
...
Burstein, J., LaFlair, G. T., Yancey, K., von Davier, A. A., \& Dotan, R. (2024). Responsible AI for test equity and quality: The Duolingo English Test as a case study. arXiv. \url{https://doi.org/10.48550/arXiv.2409.07476}
...
Eleje, L. I., Abanobi, C. C., Metu, I. C., Ezeugo, N. C., Agu, N. N., \& Mbelede, N. G. (2023). Effects of computer-based test (CBT) and paper and pencil test (PPT) on academic achievement and test anxiety of secondary school students' in Economics [Preprint]. \url{https://doi.org/10.60692/aknv7-eby98}

\bibitem[Feeney(2022)]{feeney2022rejection}
Feeney, J. (2022). Test-taker reactions to rejection. OSF Preprints. \url{https://doi.org/10.17605/OSF.IO/Q9PC3}
...
George, A. S. (2024). Exam season stress and student mental health: An international epidemic. PU Publications. \url{https://doi.org/10.5281/zenodo.10826031}
...
Kaleta, J. (2025). Student perspectives on high-stakes testing (2015--2025): An AI-assisted systematic review of empirical evidence on motivation, learning, and well-being [OSF study registration]. \url{https://doi.org/10.17605/OSF.IO/QV79W}
...
Ladant, F.-X., Hedou, J., Sestito, P., \& Bargagli-Stoffi, F. J. (2023). What is essential is visible to the eye: Saliency in primary school ranking and its effect on academic achievements. arXiv. \url{https://doi.org/10.48550/arXiv.2302.10026}
...
Mukherjee, S., Distler, V., Lenzini, G., \& Cardoso-Leite, P. (2024). Balancing the perception of cheating detection, privacy and fairness: A mixed-methods study of visual data obfuscation in remote proctoring. arXiv. \url{https://doi.org/10.48550/arXiv.2406.15074}
...
Steuart, E. L. (2024). \textit{Rural teachers' perceptions of how high-stakes testing impacts high school students} [Thesis]. University of North Carolina at Chapel Hill. \url{https://doi.org/10.17615/wxjv-3a98}
...
Stowe, K., Longwill, B., Francis, A., Aoyama, T., Ghosh, D., \& Somasundaran, S. (2024). Identifying fairness issues in automatically generated testing content. arXiv. \url{https://doi.org/10.48550/arXiv.2404.15104}

\bibitem[Suk and Lyu(2026)]{suk2026unfairness}
Suk, Y., \& Lyu, W. (2026). Identifying causes of test unfairness: Manipulability and separability. arXiv. \url{https://doi.org/10.48550/arXiv.2601.13449}
...
Wallace, L. E., \& Tonks, S. M. (2010). Investigating high-stakes testing, motivation, test anxiety, and engagement in children [Data set]. PsycEXTRA. \url{https://doi.org/10.1037/e639592010-001}

\bibitem[Watson et al.(2026)]{watson2026cat}
Watson, J., Chen, C.-W., Popov, V., \& Stillwell, D. (2026). Enhancing test-taker experience in computerised adaptive testing: A comparison of constraint methods for regulating item difficulty jumps. OSF Preprints. \url{https://osf.io/5svuy}
...
Zhang, D., Hoang, T., Pan, S., Hu, Y., Xing, Z., Staples, M., Xu, X., Lu, Q., \& Quigley, A. (2023). Test-takers have a say: Understanding the implications of the use of AI in language tests. arXiv. \url{https://doi.org/10.48550/arXiv.2307.09885}

\bibitem[Zhang(2024)]{zhangw2024naplan}
Zhang, W. (2024). A policy report evaluating the National Assessment Program for Literacy and Numeracy (NAPLAN) reform in Australia: The impacts of high stakes assessment on students. arXiv. \url{https://doi.org/10.48550/arXiv.2409.17959}
...
\bibitem[Braun(2004)]{braun2004highstakes}
Braun, H. (2004). Reconsidering the impact of high-stakes testing. https://doi.org/10.14507/epaa.v12n1.2004

\bibitem[Carrasco Aguilar et al.(2019)]{carrasco2019identidad}
Carrasco Aguilar, C., Luzón, A., \& López, V. (2019). Identidad docente y políticas de accountability: el caso de Chile. https://doi.org/10.4067/s0718-07052019000200121

\bibitem[Campos \& Guerrero Morales(2016)]{campos2016efectos}
Campos, J., \& Guerrero Morales, P. (2016). Efectos indeseados de la medición de la calidad educativa en Chile. La respuesta de la sociedad civil. https://doi.org/10.1590/cc0101-32622016171351

\bibitem[Cháves Manzano \& Ordoñez-López(2020)]{chavesmanzano2020cavilaciones}
Cháves Manzano, H. R., \& Ordoñez-López, I. D. P. (2020). Cavilaciones sobre la evaluación y la calidad educativa en Colombia. https://doi.org/10.35381/r.k.v5i9.267

\bibitem[Parcerisa \& Villalobos(2021)]{parcerisa2021movimientos}
Parcerisa, L., \& Villalobos, C. (2021). Movimientos sociales y resistencia al accountability en Chile: estrategias discursivas, identidad y acciones de la campaña Alto al SIMCE. https://doi.org/10.4067/s0718-50492021000100216
